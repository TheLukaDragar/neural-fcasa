...
python3 neural_fcasa/separate_batch_dela6_enhanced_selection_snr_merging_multispeak2.py one hf://b-sigpro/neural-fcasa --dump_diar --out_ch 3 --device cuda --thresh 0.2 "$filename" "$separated_filename"
