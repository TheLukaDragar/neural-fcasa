...
python3 neural_fcasa/separate_batch_dela2.py one hf://b-sigpro/neural-fcasa --dump_diar --out_ch 3 --device cuda --thresh 0.2 "$deverb_filename" "$separated_filename"
